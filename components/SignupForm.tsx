      ...
      <Card className="p-8 rounded-[24px] border border-gray-200 shadow-lg">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-[#1d1d1f] mb-2">
            {invitationToken ? "Complete Your Invitation" : "Get started free"}
          </h1>
        ...
        <form onSubmit={handleSignup} className="space-y-4">
          ...
          {!invitationToken && (
            <div>
              <label htmlFor="companyName" className="block text-sm font-medium text-[#1d1d1f] mb-2">
                Company Name
              </label>
              <Input
                id="companyName"
          ...
          {!useMagicLink && (
            <div>
              ...
              <Input
                ...
                className="h-12 rounded-xl border-gray-200"
              />
              <p className="text-xs text-[#86868b] mt-1">Minimum 8 characters</p>
            </div>
          )}
