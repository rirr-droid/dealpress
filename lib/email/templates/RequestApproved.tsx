...
export const RequestApprovedEmail = ({
  ...
  return (
    <Html>
      <Head />
      <Preview>✅ Approved: {dealName}</Preview>
      <Body style={main}>
        <Container style={container}>
          ...
          <Text style={text}>
            Great news! Your approval request has been <strong>approved</strong> by {approverName}.
          </Text>
          ...
          <Section style={dealCard}>
            ...
            <Text style={statusBadge}>Approved</Text>
            {comments && (
          ...
          <Text style={footer}>
            You can now proceed with this deal. All approval steps have been completed.
          </Text>
